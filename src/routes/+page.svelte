...
<section class="fixed bottom-0 w-full border-t-[1px] border-t-zinc-800 bg-black px-3 py-2 block md:block lg:hidden">
    <nav>
...
<section class="hidden h-full w-[245px] border-r-[1px] border-r-zinc-800 bg-black px-3 py-6 lg:fixed lg:block">
    <div class="px-2 py-3">
        <h1 class="font-logo mb-2 text-4xl text-white">Instagram</h1>
    </div>
    <nav>
        <ul class="flex h-full flex-col space-y-4 py-7 text-base text-white">
            <li class="hover:bg-opacity-10 flex cursor-pointer rounded-3xl py-2 hover:bg-gray-500 active:font-semibold">
