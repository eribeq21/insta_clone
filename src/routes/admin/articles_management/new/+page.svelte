...
<main
  class="flex h-screen items-center justify-center bg-black p-6 lg:ml-[220px]"
><div class="w-full max-w-md rounded-2xl p-[2px] bg-gray-100 shadow-xl">
	<div class="w-full h-full rounded-2xl bg-black p-8 border border-gray-100">
