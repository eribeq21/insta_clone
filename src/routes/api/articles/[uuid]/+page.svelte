...
<section class="main-content flex-1 lg:ml-[245px]">
    <div class="mx-auto max-w-screen-lg bg-black p-4 md:border flex flex-col md:flex-row">
        <!-- Article Image -->
            ...
            <div class="mb-4 flex flex-row items-center gap-3">
                <div class="h-11 w-11 rounded-full bg-gradient-to-r from-yellow-400 via-pink-500 to-red-500 p-0.5">
                    <div class="h-10 w-10 overflow-hidden rounded-full border-2 border-black bg-white">
                        <img class="h-full w-full object-cover" src={article.profile_picture} alt={data.article.author} />
                    </div>
                </div>
