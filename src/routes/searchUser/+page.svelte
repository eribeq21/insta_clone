...
<div class="max-w-2xl mx-auto">
    ...
    <form method="POST" name="search_user" class="flex items-center" use:enhance>
        ...
        <div class="relative w-full">
            ...
            <input type="text"   name="theUsername" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required>
    ...
    <ul>
        {#each users as user}
            <li class="mb-1">
                <a href="#" class="text-blue-600 hover:underline">{user.username}</a>
            </li>
        {/each}
    </ul>
